  ...
  return (
    <div style={{ padding: '32px' }}>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <div style={{
          display: 'grid', gridTemplateColumns: '1fr 1fr 110px 140px 100px 100px 90px',
          ...
          <span>Naam</span><span>E-mail</span><span>Pakket</span><span>Betaling</span><span>Logs 7d</span><span>Stappen/dag</span><span></span>
        </div>
